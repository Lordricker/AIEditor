...
//     version 1.14.0
//     from Assets/AiEditor/VisualScriptingInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/AiEditor/VisualScriptingInput.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @VisualScriptingInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @VisualScriptingInput()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""VisualScriptingInput"",
    ""maps"": [
        {
            ""name"": ""New action map"",
            ""id"": ""8c24bb6b-7ba4-4df5-a3b9-fe8931ad8541"",
            ""actions"": [
                {
                    ""name"": ""MouseMove"",
                    ""type"": ""Button"",
                    ""id"": ""c6a384ce-c69a-4f58-9a8e-4153e27b7417"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""MouseClick"",
                    ""type"": ""Button"",
                    ""id"": ""ef787993-9e6e-4fc6-8b1c-f6ba5ea052e5"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""3b8e2e67-3d06-4cb2-a505-5920d2a2e97b"",
                ...
                {
                    ""name"": """",
                    ""id"": ""14db522b-8609-4890-ac99-9f7854f81086"",
                    ""path"": ""<Pointer>/press"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Newactionmap_MouseMove = m_Newactionmap.FindAction("MouseMove", throwIfNotFound: true);
        m_Newactionmap_MouseClick = m_Newactionmap.FindAction("MouseClick", throwIfNotFound: true);
    }

    ~@VisualScriptingInput()
    {
        UnityEngine.Debug.Assert(!m_Newactionmap.enabled, "This will cause a leak and performance issues, VisualScriptingInput.Newactionmap.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Newactionmap_MouseMove;
    ...
    {
        private @VisualScriptingInput m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public NewactionmapActions(@VisualScriptingInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Newactionmap/MouseMove".
        /// </summary>
        public InputAction @MouseMove => m_Wrapper.m_Newactionmap_MouseMove;
        /// <summary>
        /// Provides access to the underlying input action "Newactionmap/MouseClick".
        /// </summary>
